    ...
    try {
      ...
      if (barcodeScanRes != "-1") {
        final response = await http.get(Uri.parse(
            "http://myrental.expectron.tech/cek.php?code=$barcodeScanRes"));
        log(response.body);
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  child: Text(
                                      "Scan product's barcode to add your product to inventory",
                                      style: TextStyle(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return custom.ListProduct(
                                      img:
                                          "https://bwipjs-api.metafloor.com/?bcid=code128&text=${product[index]["products_id"]}",
